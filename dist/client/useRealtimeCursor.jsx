...
exports.default = (function () {
    ...
    if (typeof window === "undefined")
        return {
            ...
            renderCursors: function () { return <div />; }
        };
    ...
    /**カーソル位置 */
    var _b = react_1.useState({ x: 0, y: 0 }), yourCursorPosition = _b[0], setYourCursorPosition = _b[1];
    /**他ユーザを含めた全てのカーソルリスト */
    var _c = react_1.useState([]), cursorList = _c[0], setCursorList = _c[1];
    /**create mutation */
    var createRealtimeCursor = useCreateRealtimeCursor_1.default();
    /**Subscription */
    var _createdCursor = useOnCreateRealtimeCursor_1.default(url);
    ...
    react_1.useEffect(function () {
        ...
        var newDisplayCursorList = clientCommonUtils_1.updateArray(cursorList, createdCursor);
    ...
    var renderCursors = function (customView) {
        return cursorList.map(function (c) {
            return (<CursorAnimate_1.CursorAnimate key={c.key} curPos={{ x: c.x, y: c.y }} userInfo={{ name: c.name, avatar: c.avator, color: c.color }} customView={customView}/>);
        });
    };

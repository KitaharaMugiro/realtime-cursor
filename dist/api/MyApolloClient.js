...
var wsLink = process.browser ? client_1.ApolloLink.from([
    aws_appsync_auth_link_1.createAuthLink({ url: wssUrl, region: "ap-northeast-1", auth: authInfo }),
    aws_appsync_subscription_link_1.createSubscriptionHandshakeLink({ url: wssUrl, region: "ap-northeast-1", auth: authInfo })
]) : null;
...
var splitLink = wsLink ? client_1.split(function (_a) {
    var query = _a.query;
